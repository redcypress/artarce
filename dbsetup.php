            ...
            <tbody>
                ...
                <tr bgcolor="#FFFFFF">
                    <td height="67" colspan="2">
                        <a href="index.html"><img src="images/nav_04.png" alt="" width="275" height="67" border="0"></a>
                    </td>
                    <td height="67" colspan="3">
                        <img src="images/nav_05.png" width="257" height="67" alt=""></td>
                    <td height="67" colspan="3">
                        <a href="location.html"><img src="images/New-Buckwheat_06.png" alt="" width="268" height="67" border="0"></a>
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td height="237" colspan="8">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td width="537" height="220" align="center" valign="middle">
                                        <p class="style29">Next Order Day:</p>
                                ...
                                following the order deadline.</strong></p>
                                        <blockquote>
                                            <p>Pick-Up your order in Knowlesville at the Knowlesville Art &amp; Nature Centre at 111 Simms Road (call 375-8623) or request local delivery option.
                                                <br>
                                            </p>
                                        </blockquote>
                                    ...
                                    <td valign="top">
                                        <form action="send.php" method="post" name="orderform" id="orderform">
                                                    ...
                                                    <tr>
                                                        <th width="100%" align="left" scope="col">
                                                            <p align="left">
                                                                ...
                                                                <input name="Name" type="text" class="required" id="Name" size="100" style="cursor: auto; background-image: url(&quot;data:image/png;base64,&quot;); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
                                            ...
                                            <blockquote>
                                                ...
                                                <p>Do you want something from Speerville Mill that is not listed? Please write it in the comments section and we will add it to your order. Download a full <a href="http://www.speervilleflourmill.ca/catalog_web.pdf" target="_blank">Speerville
                                        Mill Product list</a> and learn more about the history of the mill too! Add any product suggestions as well. We'll do our best to add them: </p>
                                            </blockquote>
                                            <p align="center">
                                            ...
                                            <p>
                                                <input name="Pick up Details" type="radio" id="Jan23order6" value="Pick up in Knowlesville" checked=""> Pick up at the Knowlesville Art &amp; Nature School
                                                <br>
