                    ...
                    <td width="537" height="220" align="center" valign="middle">
                        ...
                        <blockquote>
                            <p>Pick-Up your order in Knowlesville at the Knowlesville Art &amp; Nature Centre at 111
                                Simms Road (call 375-8623) or request local delivery option.
                                <br>
                            </p>
                        </blockquote>
                        ...
                        <form action="send.php" method="post" name="orderform" id="orderform">
                            ...
                            <p>
                                <input name="Pick up Details" type="radio" id="Jan23order6"
                                       value="Pick up in Knowlesville" checked=""> Pick up at the Knowlesville Art &amp;
                                Nature School
                                <br>
                                <input name="Pick up Details" type="radio" id="Jan23order4"
                                       value="Home Delivery to Florenceville area"> Special Delivery to Florenceville,
                                Bristol, Glassville, Knowlesville, Mount Pleasant, Bath areas
                                <br>
